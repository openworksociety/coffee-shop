...
function loadTable() {
  ...
  xhttp.open("GET", "http://localhost:8080/getmenuitems");
  xhttp.send();
...
function showUserCreateBox() {
  Swal.fire({
    ...
    html:
      ...
      '<input id="fname" class="swal2-input" placeholder="Menu Name">' +
      '<input id="lname" class="swal2-input" placeholder="Decription">' +
      '<input id="username" class="swal2-input" placeholder="Price">' +
      '<input id="email" class="swal2-input" placeholder="Test">',
    focusConfirm: false,
    preConfirm: () => {
      userCreate();
    }
